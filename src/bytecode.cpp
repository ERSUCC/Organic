...
void CallNative::output(std::ofstream& stream, BytecodeResolver* resolver) const
{
    ...
    else if (function == "equal") id = 0x05;
    else if (function == "less") id = 0x06;
    else if (function == "greater") id = 0x07;
    else if (function == "lessequal") id = 0x08;
    else if (function == "greaterequal") id = 0x09;
    else if (function == "sine") id = 0x0a;
    else if (function == "square") id = 0x0b;
    else if (function == "triangle") id = 0x0c;
    else if (function == "saw") id = 0x0d;
    else if (function == "noise") id = 0x0e;
    else if (function == "hold") id = 0x0f;
    else if (function == "lfo") id = 0x10;
    else if (function == "sweep") id = 0x11;
    else if (function == "sequence") id = 0x12;
    else if (function == "repeat") id = 0x13;
    else if (function == "random") id = 0x14;
    else if (function == "limit") id = 0x15;
    else if (function == "trigger") id = 0x16;
    else if (function == "delay") id = 0x17;
    else if (function == "perform") id = 0x18;
